...
var _colors = ['rgba(255, 0, 0, 0.3)', 'rgb(9, 47, 235)', 'rgb(73, 160, 73)', 'rgb(255, 206, 61)']
var _dataReceived = 0;
...
function SetCDRGraph(countryName) {
    ...
    _coronaChart.data.datasets = [
        CreatePeopleDataset('Confirmed', _confirmedPerCountry[countryName], 'rgba(255, 0, 0)'),
        CreatePeopleDataset('Deaths', _deathsPerCountry[countryName], 'rgb(9, 47, 235)'),
        CreatePeopleDataset('Recovered', _recoveredPerCountry[countryName], 'rgb(73, 160, 73)'),
        CreatePercentageDataset('Increase in %', _increasePerCountry[countryName], 'rgb(255, 206, 61)')
    ];
    _coronaChart.update();
}
